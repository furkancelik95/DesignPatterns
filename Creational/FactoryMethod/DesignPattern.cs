...
namespace FactoryMethod
{
    ...
    // 0. Adım: Haritada (Product) gösterilecek ziyaret noktaları
    ...
    // 1. Adım: Product: Fabrikanızın geliştireceği ürün(abstract class ya da interface olmalı):
    public interface IMap
    {
        public List<IVisitPoint> VisitPoints { get; set; }
    }

    // 2. Adım: Concrete Product: Üretilecek ürünleri tanımlayan nesneler:
    ...
    // 3. Adım: Creator: İhtiyaç duyduğunuz ürünü oluşturacak (Fabrika) sınıf:
